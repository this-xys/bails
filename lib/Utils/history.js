  ...
  switch (item.syncType) {
    ...
    case proto.HistorySync.HistorySyncType.ON_DEMAND:
      for (const chat of item.conversations) {
        contacts.push({ id: chat.id, name: chat.displayName || chat.name || chat.username || void 0, username: chat.username || void 0, lid: chat.lidJid || chat.accountLid || void 0, phoneNumber: chat.pnJid || void 0 });
...
const getHistoryMsg = (message) => {
  const normalizedContent = !!message ? normalizeMessageContent(message) : void 0;
